...
var import_shallowequal = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var N = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", C = "undefined" != typeof window && "HTMLElement" in window, I = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env && (void 0 !== process.env.REACT_APP_SC_DISABLE_SPEEDY && "" !== process.env.REACT_APP_SC_DISABLE_SPEEDY ? "false" !== process.env.REACT_APP_SC_DISABLE_SPEEDY && process.env.REACT_APP_SC_DISABLE_SPEEDY : void 0 !== process.env.SC_DISABLE_SPEEDY && "" !== process.env.SC_DISABLE_SPEEDY ? "false" !== process.env.SC_DISABLE_SPEEDY && process.env.SC_DISABLE_SPEEDY : true)), O = {
...
var j = function() {
	...
	function e(e) {
		this.nodes = (this.element = q(e)).childNodes, this.length = 0;
	}
	var t = e.prototype;
	return t.insertRule = function(e, t) {
...
var ce = import_react.createContext();
ce.Consumer;
var le = import_react.createContext(), de = (le.Consumer, new X()), he = ae();
function pe() {
...
var require_typeof = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	function _typeof2(obj) {
		if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") _typeof2 = function _typeof2(obj) {
			return typeof obj;
		};
	...
	function _typeof(obj) {
		if (typeof Symbol === "function" && _typeof2(Symbol.iterator) === "symbol") module.exports = _typeof = function _typeof(obj) {
			return _typeof2(obj);
		};
...
//#endregion
//#region node_modules/react-swipeable-views-core/lib/checkIndexBounds.js
var require_checkIndexBounds = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault = require_interopRequireDefault();
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = void 0;
	var _react = _interopRequireDefault(require_react());
	var _warning = _interopRequireDefault(require_warning());
	exports.default = function checkIndexBounds(props) {
...
//#endregion
//#region node_modules/react-swipeable-views-core/lib/constant.js
...
//#endregion
//#region node_modules/react-swipeable-views-core/lib/computeIndex.js
var require_computeIndex = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault = require_interopRequireDefault();
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/react-swipeable-views-core/lib/getDisplaySameSlide.js
var require_getDisplaySameSlide = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault = require_interopRequireDefault();
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = void 0;
	var _react = _interopRequireDefault(require_react());
	exports.default = function getDisplaySameSlide(props, nextProps) {
		var displaySameSlide = false;
		var getChildrenKey = function getChildrenKey(child) {
			return child ? child.key : "empty";
		};
		if (props.children.length && nextProps.children.length) {
			var oldKey = _react.default.Children.map(props.children, getChildrenKey)[props.index];
			if (oldKey !== null && oldKey !== void 0) {
				if (oldKey === _react.default.Children.map(nextProps.children, getChildrenKey)[nextProps.index]) displaySameSlide = true;
			}
		}
...
//#endregion
//#region node_modules/react-swipeable-views-core/lib/mod.js
...
//#endregion
//#region node_modules/react-swipeable-views-core/lib/index.js
var require_lib$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _mod = _interopRequireDefault(require_lib$2());
}));
//#endregion
//#region node_modules/react-swipeable-views/lib/SwipeableViews.js
var require_SwipeableViews = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault = require_interopRequireDefault();
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var _warning = _interopRequireDefault(require_warning());
	var _reactSwipeableViewsCore = require_lib$1();
	...
	function getDomTreeShapes(element, rootNode) {
		...
		while (element && element !== rootNode) {
			...
			else if (element.clientWidth > 0 && element.scrollWidth > element.clientWidth || element.clientHeight > 0 && element.scrollHeight > element.clientHeight) domTreeShapes.push({
				element,
	...
	var SwipeableViews = /* @__PURE__ */ function(_React$Component) {
		...
		function SwipeableViews(props) {
			...
			_this.handleSwipeMove = function(event) {
				...
				_this.vx = _this.vx * .5 + (touch.pageX - _this.lastX) * .5;
				_this.lastX = touch.pageX;
				...
				if (nodeWhoClaimedTheScroll === null && !ignoreNativeScroll) {
					if (findNativeHandler({
						domTreeShapes: getDomTreeShapes(event.target, _this.rootNode),
						startX: _this.startX,
						pageX: touch.pageX,
						axis
					})) return;
			...
			_this.handleSwipeEnd = function() {
				...
				var indexNew;
				if (Math.abs(_this.vx) > _this.props.threshold) if (_this.vx > 0) indexNew = Math.floor(indexCurrent);
				else indexNew = Math.ceil(indexCurrent);
				else if (Math.abs(delta) > _this.props.hysteresis) indexNew = delta > 0 ? Math.floor(indexCurrent) : Math.ceil(indexCurrent);
				...
				_this.setState({
					...
					if (_this.props.onChangeIndex && indexNew !== indexLatest) _this.props.onChangeIndex(indexNew, indexLatest, { reason: "swipe" });
			...
			_this.handleScroll = function(event) {
				...
				if (_this.props.onChangeIndex && indexNew !== indexLatest) _this.props.onChangeIndex(indexNew, indexLatest, { reason: "focus" });
			};
			_this.updateHeight = function() {
				if (_this.activeSlide !== null) {
					var child = _this.activeSlide.children[0];
					if (child !== void 0 && child.offsetHeight !== void 0 && _this.state.heightLatest !== child.offsetHeight) _this.setState({ heightLatest: child.offsetHeight });
				}
			};
		...
		(0, _createClass2.default)(SwipeableViews, [
			{
				...
				value: function getChildContext() {
					var _this2 = this;
					return { swipeableViews: { slideUpdateHeight: function slideUpdateHeight() {
						_this2.updateHeight();
					} } };
				}
			},
			{
				...
				value: function componentDidMount() {
					...
					this.transitionListener = addEventListener(this.containerNode, "transitionend", function(event) {
						if (event.target !== _this3.containerNode) return;
					...
					if (!this.props.disableLazyLoading) this.firstRenderTimeout = setTimeout(function() {
						_this3.setState({ renderOnlyActive: false });
					}, 0);
					if (this.props.action) this.props.action({ updateHeight: this.updateHeight });
				}
			},
			{
			...
			},
			{
				...
				value: function render() {
					var _this4 = this, _this$props2 = this.props;
					_this$props2.action;
					...
					var slideStyleProp = _this$props2.slideStyle, slideClassName = _this$props2.slideClassName, springConfig = _this$props2.springConfig, style = _this$props2.style;
					_this$props2.threshold;
					var other = (0, _objectWithoutProperties2.default)(_this$props2, [
						"action",
						"animateHeight",
						"animateTransitions",
						"axis",
					...
					}, other, touchEvents, mouseEvents, { onScroll: this.handleScroll }), _react.default.createElement("div", {
	...
	SwipeableViews.childContextTypes = { swipeableViews: _propTypes.default.shape({ slideUpdateHeight: _propTypes.default.func }) };
	exports.default = SwipeableViews;
}));
//#endregion
//#region node_modules/react-brackets/dist/index.modern.js
var import_lib = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault = require_interopRequireDefault();
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = void 0;
	exports.default = _interopRequireDefault(require_SwipeableViews()).default;
})))());
function _objectWithoutPropertiesLoose(source, excluded) {
	if (source == null) return {};
	var target = {};
...
var Bracket = qe.div(function(props) {
	return "\n  display: flex;\n  flex-direction: row;\n  @media (max-width: " + props.mobileBreakpoint + "px) {\n    flex-direction: column;\n  }\n  ";
});
var Round = qe.div(function(props) {
	return "\n  flex: 0;\n  // min-width:300px;\n  display:flex;\n  flex-direction:column;\n  @media (max-width: " + props.mobileBreakpoint + "px) {\n    min-width:0;\n  }\n  ";
});
var RoundTitle = qe.div(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  color: #8f8f8f;\n  font-weight: 400;\n  text-align: center;\n"])));
var SeedsList = qe.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(["\n  margin: 0;\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  flex-flow: row wrap;\n  justify-content: center;\n  height: 100%;\n  list-style: none;\n"])));
function useMedia(breakPoint) {
	...
	(0, import_react.useEffect)(function() {
		function screenResized() {
			if (isSmaller && window.innerWidth > breakPoint) setIsSmaller(false);
			else if (!isSmaller && window.innerWidth <= breakPoint) setIsSmaller(true);
		}
...
var SeedItem = qe.div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteralLoose(["\n  color: #fff;\n  width: 100%;\n  background-color: #1a1d2e;\n  padding: 0;\n  border-radius: 0.2em;\n  box-shadow: 0 2px 4px -2px #111630;\n  text-align: center;\n  position: relative;\n"])));
var SeedTeam = qe.div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteralLoose(["\n  padding: 0.3rem 0.5rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-radius: 0.2em;\n  align-items: center;\n"])));
var SeedTime = qe.div(function(props) {
	return "\nmargin-top: 2px;\nfont-size: 12px;\ncolor: #8f8f8f;\nheight: 0;\n@media (max-width: " + props.mobileBreakpoint + "px) {\n  height:auto;\n}\n";
});
var SingleLineSeed = qe.div(function(props) {
	return "\npadding: 1em 1.5em;\nmin-width: 225px;\nwidth:100%;\nposition: relative;\ndisplay: flex;\nalign-items: center;\nflex: 0 1 auto;\nflex-direction: column;\njustify-content: center;\nfont-size: 14px;\n@media (max-width: " + props.mobileBreakpoint + "px) {\n  width:100%;\n}\n@media (min-width: " + ((props.mobileBreakpoint || 0) + 1) + "px) {\n  &::after {\n      content: \"\";\n      position: absolute;\n      height: 50%;\n      width: 3em;\n    [dir=\"rtl\"] & {\n      left: -1.5em;\n    }\n    [dir=\"ltr\"] & {\n      right: -1.5em;\n    }\n  }\n  &:nth-child(even)::after {\n    border-bottom: 1px solid #707070;\n    top: -0.5px;\n  }\n  &:nth-child(odd)::after {\n    border-top: 1px solid #707070;\n    top: calc(50% - 0.5px);\n  }\n}\n";
});
var Seed = qe.div(function(props) {
	return "\n  padding: 1em 1.5em;\n  min-width: 225px;\n  width:100%;\n  position: relative;\n  display: flex;\n  align-items: center;\n  flex: 0 1 auto;\n  flex-direction: column;\n  justify-content: center;\n  font-size: 14px;\n  @media (max-width: " + props.mobileBreakpoint + "px) {\n    width:100%;\n  }\n  @media (min-width: " + ((props.mobileBreakpoint || 0) + 1) + "px) {\n    &::after {\n        content: \"\";\n        position: absolute;\n        height: 50%;\n        width: 1.5em;\n      [dir=\"rtl\"] & {\n        left: 0px;\n      }\n      [dir=\"ltr\"] & {\n        right: 0px;\n      }\n    }\n\n    &:nth-child(even)::before{\n      content:'';\n      border-top: 1px solid #707070;\n      position:absolute;\n      top: -0.5px;\n      width:1.5em;\n      [dir=\"rtl\"] & {\n        left:-1.5em;\n        }\n      [dir=\"ltr\"] & {\n        right:-1.5em;\n      }\n    }\n\n    &:nth-child(even)::after {\n      border-bottom: 1px solid #707070;\n      top: -0.5px;\n     [dir=\"rtl\"] & {\n        border-left: 1px solid #707070;\n        }\n      [dir=\"ltr\"] & {\n        border-right: 1px solid #707070;\n      }\n    }\n    &:nth-child(odd):not(:last-child)::after {\n      border-top: 1px solid #707070;\n      top: calc(50% - 0.5px);\n      [dir=\"rtl\"] & {\n        border-left: 1px solid #707070;\n        }\n      [dir=\"ltr\"] & {\n        border-right: 1px solid #707070;\n      }\n    }\n}\n";
});
var renderTitle = function renderTitle(title) {
	return import_react.createElement(RoundTitle, null, title);
};
var renderSeed = function renderSeed(_ref) {
	...
	return import_react.createElement(Seed, { mobileBreakpoint: breakpoint }, import_react.createElement(SeedItem, null, import_react.createElement("div", null, import_react.createElement(SeedTeam, null, ((_seed$teams = seed.teams) === null || _seed$teams === void 0 ? void 0 : (_seed$teams$ = _seed$teams[0]) === null || _seed$teams$ === void 0 ? void 0 : _seed$teams$.name) || "-----------"), import_react.createElement(SeedTeam, null, ((_seed$teams2 = seed.teams) === null || _seed$teams2 === void 0 ? void 0 : (_seed$teams2$ = _seed$teams2[1]) === null || _seed$teams2$ === void 0 ? void 0 : _seed$teams2$.name) || "-----------"))), import_react.createElement(SeedTime, { mobileBreakpoint: breakpoint }, seed === null || seed === void 0 ? void 0 : seed.date));
};
var _excluded = ["ref"];
var SingleElimination = function SingleElimination(_ref) {
	...
	var data = rounds.map(function(round, roundIdx) {
		return import_react.createElement(Round, {
			key: round.title,
			className: roundClassName,
			mobileBreakpoint
		}, round.title && roundTitleComponent(round.title, roundIdx), import_react.createElement(SeedsList, null, round.seeds.map(function(seed, idx) {
			return import_react.createElement(import_react.Fragment, { key: seed.id }, renderSeedComponent({
				seed,
	...
	if (isResponsive) {
		...
		return import_react.createElement(Bracket, {
			className: bracketClassName,
			dir: rtl ? "rtl" : "ltr",
			mobileBreakpoint
		}, import_react.createElement(import_lib.default, Object.assign({
