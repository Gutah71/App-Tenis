      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 mt-1.5">
                {role === 'PLAYER'
                  ? 'Inscríbete en torneos y ligas, reporta resultados y sigue tu progreso.'
                  : 'Crea torneos y ligas, genera cuadros y gestiona la competición.'}
              </p>
            </div>
            <button
              type="submit"
          ...
          <p className="mt-5 text-sm text-gray-500 text-center">
            ¿Ya tienes cuenta?{' '}
            <Link to="/login" className="text-brand-green hover:text-brand-green-light font-medium transition-colors">
              Inicia sesión
            </Link>
          </p>
        </div>
